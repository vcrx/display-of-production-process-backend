...
var radialAxisMixin = {
	...
	getOffset: function () {
		...
		this.flot_chart.axisOffset[this.side] = 0;
	},
	...
	getLinePath: function (lineWidth, radius) {
		...
		return this.flot_chart.renderer.symbols.arc(
			this.left + center[0],
			this.top + center[1],
			radius,
			radius, 
	...
	getPlotBandPath: function (from, to, options) {
		...
		// Circular grid bands
			...
			ret = this.flot_chart.renderer.symbols.arc(
				this.left + center[0],
				this.top + center[1],
				radii[0],
				radii[0],
...
wrap(axisProto, 'init', function (proceed, chart, userOptions) {
	...
	if (!isHidden && (angular || polar)) {
		...
		chartOptions.flot_chart.zoomType = null;
...
seriesTypes.arearange = Highcharts.extendClass(seriesTypes.area, {
	...
	drawDataLabels: function () {
		...
		var data = this.data,
			...
			point,
			inverted = this.flot_chart.inverted;
...
var GaugeSeries = {
	...
	drawPoints: function () {
		...
		var series = this,
			...
			renderer = series.flot_chart.renderer;
	...
	render: function () {
		this.group = this.plotGroup(
			...
			this.options.zIndex, 
			this.flot_chart.seriesGroup
		);
		seriesTypes.pie.prototype.render.call(this);
		this.group.clip(this.flot_chart.clipRect);
	},
...
seriesTypes.waterfall = extendClass(seriesTypes.column, {
	...
	translate: function () {
		...
		for (i = 0, len = points.length; i < len; i++) {
			...
			stackPoint = stack.points[series.old_index];
...
seriesTypes.bubble = extendClass(seriesTypes.scatter, {
	...
	drawLegendSymbol: function (legend, item) {
		...
		item.legendSymbol = this.flot_chart.renderer.circle(
			radius,
...
wrap(seriesProto, 'translate', function (proceed) {
	...
	if (this.flot_chart.polar && !this.preventPostTranslate) {
...
wrap(seriesProto, 'getSegmentPath', function (proceed, segment) {
	...
	// Connect the path
	if (this.flot_chart.polar && this.options.connectEnds !== false &&
...
wrap(colProto, 'translate', function (proceed) {
	...
	var xAxis = this.xAxis,
		...
		renderer = this.flot_chart.renderer,
		start,
		points,
		point,
		i;
