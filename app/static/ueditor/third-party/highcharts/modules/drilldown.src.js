...
(function (H) {
	...
	PieSeries.prototype.animateDrilldown = function (init) {
		var level = this.flot_chart.drilldownLevels[this.flot_chart.drilldownLevels.length - 1],
	...
	PieSeries.prototype.animateDrillupTo = 
		...
		if (!init) {
			...
			}, Math.max(this.flot_chart.options.drilldown.animation.duration - 50, 0));
	...
	ColumnSeries.prototype.animateDrilldown = function (init) {
		var animateFrom = this.flot_chart.drilldownLevels[this.flot_chart.drilldownLevels.length - 1].shapeArgs,
			animationOptions = this.flot_chart.options.drilldown.animation;
	...
	function (level) {
		var animationOptions = this.flot_chart.options.drilldown.animation,
			group = this.group;
	...
	wrap(H.Series.prototype, 'drawDataLabels', function (proceed) {
		var css = this.flot_chart.options.drilldown.activeDataLabelStyle;
