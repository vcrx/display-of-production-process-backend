...
class AlarmForm(FlaskForm):
    sshc_cksf_up = AlarmField("松散回潮出口水分上限")
    sshc_cksf_down = AlarmField("松散回潮出口水分下限")
    yjl_rksf_up = AlarmField("叶加料入口水分上限")
    yjl_rksf_down = AlarmField("叶加料入口水分下限")
    yjl_wlljzl_up = AlarmField("叶加料物料累积重量上限")
    yjl_wlljzl_down = AlarmField("叶加料物料累积重量下限")
    yjl_wlssll_up = AlarmField("叶加料物料实时流量上限")
    yjl_wlssll_down = AlarmField("叶加料物料实时流量下限")
    yjl_lywd_up = AlarmField("叶加料料液温度上限")
    yjl_lywd_down = AlarmField("叶加料料液温度下限")
    yjl_ljjsl_up = AlarmField("叶加料累积加水量上限")
    yjl_ljjsl_down = AlarmField("叶加料累积加水量下限")
    yjl_ssjsl_up = AlarmField("叶加料瞬时加水量上限")
    yjl_ssjsl_down = AlarmField("叶加料瞬时加水量下限")
    yjl_wd_up = AlarmField("叶加料温度上限")
    yjl_wd_down = AlarmField("叶加料温度下限")
    yjl_sd_up = AlarmField("叶加料湿度上限")
    yjl_sd_down = AlarmField("叶加料湿度下限")
    yjl_ckwd_up = AlarmField("叶加料出口温度上限")
    yjl_ckwd_down = AlarmField("叶加料出口温度下限")
    yjl_cksf_up = AlarmField("叶加料出口水分上限")
    yjl_cksf_down = AlarmField("叶加料出口水分下限")
    cy_wd_up = AlarmField("储叶温度上限")
    cy_wd_down = AlarmField("储叶温度下限")
    cy_sd_up = AlarmField("储叶湿度上限")
    cy_sd_down = AlarmField("储叶湿度下限")
    qs_wd_up = AlarmField("切丝温度上限")
    qs_wd_down = AlarmField("切丝温度下限")
    qs_sd_up = AlarmField("切丝湿度上限")
    qs_sd_down = AlarmField("切丝湿度下限")
